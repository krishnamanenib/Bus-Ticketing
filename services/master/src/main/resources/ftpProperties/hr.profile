...
export JMS_PROP_DIR=com/nike/hr/jmsClients/properties
export FTP_PROP_DIR=com/nike/hr/ftp/properties
export FTP_CONFIG_DIR=com/nike/hr/ftp/config

export FTP_LOG_DIR=!!osb.file.logdir!!/application/hr/ftp
export SCRIPTS_LOG_DIR=!!osb.file.logdir!!/application/hr/scripts
export SCRIPTS_DIR=!!osb.file.scriptsdir!!/hr
...
export AUTOSYS_JMS_HOST=!!osb.jms.hr.autosys.host!!
export AUTOSYS_JMS_PORT=!!osb.jms.hr.autosys.port!!
...
#I183 -Empty_file
export CM_SAL_56_EMPTYFILE_OUTPUT_DIR=/hr/CM/GBL/out

#SAPHCM
export SAP_AD_PORTAL_INPUT_DIR=!!osb.file.datadir!!/hr/PA/GBL/in
