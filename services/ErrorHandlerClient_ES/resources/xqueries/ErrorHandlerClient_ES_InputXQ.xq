(:: pragma bea:global-element-return element="ns0:ErrorProcessing" location="../schemas/Errorhandler_Listener_XSD_1.00.xsd" ::)

declare namespace ns0 = "http://www.Nike.GeneralError/XmlSchema";
declare namespace xf = "http://tempuri.org/ErrorHandlerClient/resources/xqueries/ErrorHandlerClient_InputXQ/";
...
declare variable $MessagePayload as xs:string external;
